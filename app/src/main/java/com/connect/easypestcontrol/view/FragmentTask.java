...
public class FragmentTask extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        selectedAdapter.addFragments(new FragmentServiceToday("TaskToday"),"Today");
        selectedAdapter.addFragments(new FragmentServiceWeek("TaskWeek"),"Week");
        selectedAdapter.addFragments(new FragmentServiceMonth("TaskMonth"),"Month");
