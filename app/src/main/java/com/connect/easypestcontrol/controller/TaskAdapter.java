...
import com.connect.easypestcontrol.view.TaskDetailsScreen;
...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder>{
    ...
    public TaskAdapter(Context context, List<Customer> customerlist) {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.view_more.setOnClickListener(v -> {
            ...
            try{
                ...
                ed.apply();
                context.startActivity(new Intent(context, TaskDetailsScreen.class));
            }catch (Exception e) {
                e.printStackTrace();
            }
        });
